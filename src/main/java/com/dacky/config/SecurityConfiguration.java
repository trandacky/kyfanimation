...
import com.dacky.security.oauth2.AudienceValidator;
import com.dacky.security.oauth2.JwtGrantedAuthorityConverter;
import com.dacky.web.filter.SpaWebFilter;
...
public class SecurityConfiguration {
    ...
    public SecurityWebFilterChain springSecurityFilterChain(ServerHttpSecurity http) {
        ...
        .and()
            ...
            .pathMatchers("/api/user/info").hasAuthority(AuthoritiesConstants.USER)
